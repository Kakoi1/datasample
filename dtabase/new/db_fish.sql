...
INSERT INTO `tbl_costumer` (`c_id`, `c_name`, `c_username`, `c_password`, `c_contact_no.`, `c_address`, `c_status`, `c_image`) VALUES
...
(23, 'gggg', 'gggg', 'weu0kz4GzlYXSD9mXiZifA==', 'gggg', 'gggg', 'pending', ''),
...
--
ALTER TABLE `tbl_costumer`
  MODIFY `c_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;
