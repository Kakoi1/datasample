 ...
 * @author College-PC
 */
public class tblpro extends javax.swing.JFrame {

    /**
     * Creates new form tblpro
     */
    public tblpro() {
        initComponents();
        displaydata();
...
//        search.setBackground(new Color(0,0,0,0));
 ...
 Color headcolor = new Color(255,153,153);
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Fish Products");
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
        ...
        if(rowindex<0){
            ...
            uri.id.setText(ids);
            uri.bid.setText(buyid);
            uri.bna.setText(bname);
            uri.bad.setText(baddr);
            uri.unm=usern;
            uri.actions = yawa;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tblpro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
